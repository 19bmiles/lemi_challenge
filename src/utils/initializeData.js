...
// Run this once by importing it in App.jsx temporarily
...
export const initializeChallenge = async () => {
  console.log('Starting to initialize challenge data...');
  ...
  try {
    ...
    await setDoc(doc(db, 'challenges', 'wedding2025'), challengeData);
    console.log('✅ Challenge data initialized successfully!');
    console.log('Data written:', challengeData);
    return true;
  } catch (error) {
...
// To use this:
// 1. Import in App.jsx: import { initializeChallenge } from './utils/initializeData';
// 2. Call it once in a useEffect: 
//    useEffect(() => { initializeChallenge(); }, []);
// 3. Remove the import and useEffect after running once